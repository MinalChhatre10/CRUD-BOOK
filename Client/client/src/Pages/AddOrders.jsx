...
const AddOrders = () => {
  ...
  const handleClick = async () => {
    try {
      ...
      const clientResult = await axios.get('http://localhost:8800/client/' + formData.idClient);
      
      

      // Check if the book record exists
      const bookResult = await axios.get('http://localhost:8800/book/' + formData.id);
  ...
  return (
    ...
    <div className="form">
      ...
      <input type="text" name="id" onChange={handleChange} placeholder='Enter valid book id' />
